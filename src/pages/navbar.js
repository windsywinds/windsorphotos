...
export default function Navbar() {
  return (
    <div className='max-w-[85%] min-h-[30px] ml-3 sm:ml-9 md:ml-[10%]  flex items-center justify-between gap-9 lg:gap-0  '>
      
      <div className="pr-0 sm:pr-6 pt-1 md:pr-0 md:pt-0 ">
      <Image src={logo} alt='Logo' className='w-auto  min-w-[80px] md:max-h-28 ' />
    </div>

    <div className="flex md:gap-16 sm:gap-6 gap-3">
